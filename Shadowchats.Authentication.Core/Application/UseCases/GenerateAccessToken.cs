...
namespace Shadowchats.Authentication.Core.Application.UseCases
{
    ...
    {
        public record GenerateAccessTokenCommand : IQuery<GenerateAccessTokenResult>
        {
        ...
        public class GenerateAccessTokenHandler : IMessageHandler<GenerateAccessTokenCommand, GenerateAccessTokenResult>
        {
